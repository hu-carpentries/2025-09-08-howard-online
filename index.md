...
latitude: "38.922684"        # decimal latitude of workshop venue (use https://www.latlong.net/)
longitude: "-77.019440"       # decimal longitude of the workshop venue (use https://www.latlong.net)
humandate: "Sep 8-15, 2025"    # human-readable dates for the workshop (e.g., "Feb 17-18, 2020")
humantime: "4:00 pm - 7:00pm (EST)"    # human-readable times for the workshop e.g., "9:00 am - 4:30 pm CEST (7:00 am - 2:30 pm UTC)"
...
instructor: ["Nathan Alexander", "Hye Ryeon Jang"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
helper: ["Lyrric Jackson", "Bayowa Onabajo"]     # boxed, comma-separated list of helpers' names, like ["Marlyn Wescoff", "Fran Bilas", "Ruth Lichterman"]
...
eventbrite:           # optional: alphanumeric key for Zoom or Eventbrite registration, e.g., "1234567890AB" (if Eventbrite is being used)
what3words: gifted.rust.asks          # optional: what3words (https://what3words.com) address of the workshop venue, without leading slashes e.g. "globe.lessening.computers"
---
